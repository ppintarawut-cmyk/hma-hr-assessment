...
เขียนขึ้นเพราะผู้สมัครไม่กล้ากดลิงก์และโทรมาถามว่าของจริงไหม ตัวอีเมลจึงต้องทำงานคู่กับ
แผงยืนยันตัวตนบนหน้าแรกของระบบ — ถ้าสองอย่างนี้ไม่ตรงกัน ผู้สมัครจะยิ่งไม่มั่นใจ

## กติกา — ข้อไหนทำไม่ได้ ผู้สมัครจะกลับมาสงสัยอีก
...
ฝ่ายทรัพยากรบุคคลขอเชิญท่านทำแบบทดสอบออนไลน์ ใช้เวลาประมาณ **[X] นาที**
...
**ข้อมูลที่ระบบจะขอ:** ชื่อ-นามสกุล · อีเมล · เบอร์โทรศัพท์ · อายุ · ประสบการณ์ทำงาน ·
ตำแหน่งที่สมัคร

**ข้อมูลที่เราจะไม่ขอเด็ดขาด:** รหัสผ่าน · เลขบัตรประชาชน · สำเนาบัตรประชาชน ·
...
**Subject:** Assessment for your [Position] application — Hino Motors Asia

Dear [Candidate name],

Thank you for applying for the **[Position]** role at Hino Motors Asia Ltd. Our HR team
would like to invite you to complete an online assessment, which takes about **[X] minutes**.

Here is the link — please check that your address bar matches this text exactly:
...
**What the system will ask for:** full name · email · phone number · age · years of
experience · the position you applied for

**What we will never ask for:** a password · your national ID number or a copy of your ID
